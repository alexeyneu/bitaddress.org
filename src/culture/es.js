(function (translator) {
	translator.translations["es"] = {
		...
		"paperlabelbitcoinaddress": "Dirección Goldencoin:",
		...
		"tagline": "Generador de carteras Goldencoin de código abierto en lado de cliente con Javascript",
		"generatelabelbitcoinaddress": "Generando dirección Goldencoin...",
		...
		"singlelabelbitcoinaddress": "Dirección Goldencoin",
		...
		"bulklabelq1": "¿Por qué debo usar \"Direcciones en masa\" para aceptar Goldencoins en mi web?",
		...
		"bulklabela2li3": "Ofrece una alternativa en el carro de la compra de tu web para que los clientes paguen con Goldencoin. Cuando el cliente elija pagar con Goldencoin, les muestras una de las direcciones de la base de datos como su \"dirección de pago\" y guardas esto junto con el pedido.",
		...
		"brainlabelbitcoinaddress": "Dirección Goldencoin:",
		...
		"vanitylabelbitcoinaddress": "Dirección Goldencoin personalizada:",
		...
		"detaillabelnote2": "Goldencoin v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		"detaillabelbitcoinaddress": "Dirección Goldencoin:",
		"detaillabelbitcoinaddresscomp": "Dirección Goldencoin (comprimida):",
